...
Lifecycle and flow tests in the root test directory substitute Home Assistant
boundaries. They verify our logic, not Home Assistant's platform loader,
scheduler, schema validation, or UI. The separate runtime suite below uses HA.
